...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Nomor Surat</td><td><b><input type="text" name="no_surat" tabindex="3" required value="<?php echo $no_surat; ?>" style="width: 400px" class="form-control"></td></tr>	
	...
	<div class="col-lg-6">	
		<table  class="table-form">
		<tr></tr>
		<tr><td width="20%">Indeks Berkas</td><td><b><input type="text" name="indek_berkas" tabindex="6" value="<?php echo $indek_berkas; ?>" style="width: 100px" class="form-control"></b></td></tr>
		...
		<tr><td width="20%">File Surat (Scan)</td><td><b><input type="file" name="file_surat" tabindex="8" style="width: 200px"></b></td></tr>
