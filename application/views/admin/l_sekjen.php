	...
	<div class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">Sekjen</a>
			</div>
		<div class="navbar-collapse collapse navbar-inverse-collapse" style="margin-right: -20px">
			...
			<ul class="nav navbar-nav navbar-right">
				<form class="navbar-form navbar-left" method="post" action="<?php echo base_URL(); ?>index.php/admin/sekjen/cari">
...
<table class="table table-bordered table-hover">
	<thead>
		<tr>
			...
			<th width="20%">Pagu (Rp.)</th>
			<th width="20%">Metode Pemilihan Penyedia</th>
	...
	<tbody>
		...
		<tr>
			<td><?php echo $b->no;?></td>
			<td><?php echo $b->namapkt;?></td>
			<td><?php echo $b->pagu;?></td>
			<td><?php echo $b->metode;?></td>
			<td><?php echo $b->sumberdana?></td>
			<td class="ctr">
			<!-- 	<?php  
